const {createHandler, createResolver, setupGraphql, setupRest} = require('../lib/index');

const {createResolver: createResolverUtil, setupGraphql: setupGraphqlUtil} = require('../lib/setup-graphql-resolvers');
const {createHandler: createHandlerUtil, setupRest: setupRestUtil} = require('../lib/setup');
